...
def QuFeX_12_1_3(input, splits):
    ...
    # q_split = tf.split(input, num_or_size_splits = [3, 3, 2], axis=-1)

    patch_height = 2
    patch_width = 2

    channels = n_qubits // (patch_height*patch_width)
    if channels == 0:
        channels = 1
